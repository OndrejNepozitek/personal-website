...
You can find a .NET implementation of the algorithm on [my github](https://github.com/OndrejNepozitek/Edgar-DotNet). The repository contains a .NET DLL and a WinForms GUI application which is controlled by YAML configuration files.
